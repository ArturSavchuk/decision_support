...
namespace Lab4
{
    class Program
    {
        ...
        public static WeightedCriteriaRelation ReadWeightedCriteriaRelation()
        {
            ...
            string fileName = $"{directoryPath}\\Lab4\\var52_task.txt";
            ...
            List<double> weights = new List<double> { 9, 10, 3, 7, 6, 2, 5, 7, 7, 1, 10, 1 };

            return new WeightedCriteriaRelation(relation, weights, c: 0.545, d: 0.292);
        }
        ...
        public static void Task22(WeightedCriteriaRelation weightedCriteriaRelation)
        {
            ...
            string directoryPath = Directory.GetParent(Directory.GetCurrentDirectory()).Parent.Parent.FullName;
            string fileName = $"{directoryPath}\\Lab4\\sizes-c.txt";
            File.WriteAllText(fileName, string.Empty);
            File.WriteAllLines(fileName,
                new List<string>
                {
        ...
        public static void Task23(WeightedCriteriaRelation weightedCriteriaRelation)
        {
            ...
            string directoryPath = Directory.GetParent(Directory.GetCurrentDirectory()).Parent.Parent.FullName;
            string fileName = $"{directoryPath}\\Lab4\\sizes-cd.txt";
            File.WriteAllText(fileName, string.Empty);
            File.WriteAllLines(fileName,
                new List<string>
                {
